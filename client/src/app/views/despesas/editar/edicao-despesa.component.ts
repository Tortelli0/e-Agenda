...
import { FormaPgtoDespesaEnum, EditarDespesaViewModel, DespesaEditadaViewModel } from '../models/despesa.model';
...
export class EdicaoDespesaComponent {
  ...
  private processarSucesso(registro: DespesaEditadaViewModel): void {
    this.notificacaoService.sucesso(`Despesa "${registro.descricao}" editada com sucesso!`);
