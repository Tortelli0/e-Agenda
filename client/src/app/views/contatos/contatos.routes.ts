...
import { ListarContatoViewModel, VisualizarContatoViewModel } from "./models/contato.model";
...
export const contatosRoutes: Routes = [
  ...
  { path: 'editar/:id', component: EdicaoContatoComponent, resolve: {
    contato: visualizarContatoResolver,
    },
  },

  { path: 'excluir/:id', component: ExclusaoContatoComponent, resolve: {
    contato: visualizarContatoResolver,
    },
  },
];
