...
export const contatosRoutes: Routes = [
  ...
  { path: 'listar', component: ListagemContatosComponent, resolve: { contatos: listagemContatosResolver, }, },

  { path: 'cadastrar', component: CadastroContatoComponent },

  { path: 'editar/:id', component: EdicaoContatoComponent, resolve: { contato: visualizarContatoResolver, }, },

  { path: 'excluir/:id', component: ExclusaoContatoComponent, resolve: { contato: visualizarContatoResolver, }, },
];
