...
import { PrioridadeTarefaEnum, InserirTarefaViewModel, TarefaInseridaViewModel } from '../models/tarefa.models';
...
export class CadastroTarefaComponent {
  ...
  private processarSucesso(registro: TarefaInseridaViewModel): void {
    this.notificacaoService.sucesso(`Tarefa "${registro.titulo}" cadastrada com sucesso!`);
